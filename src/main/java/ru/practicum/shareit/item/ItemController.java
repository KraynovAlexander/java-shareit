...
public class ItemController {
    ...
    @GetMapping
    public List<ItemDto> getAllByUserId(@RequestHeader(Constants.SHARER) @NotNull Long userId) {
    ...
    @PostMapping
    public ItemDto create(@RequestHeader(Constants.SHARER) @NotNull Long userId,
    ...
    @PatchMapping("{id}")
    public ItemDto update(@RequestHeader(Constants.SHARER) @NotNull Long userId,
    ...
    public CommentDto createComment(@RequestHeader(Constants.SHARER) @NotNull Long userId,
