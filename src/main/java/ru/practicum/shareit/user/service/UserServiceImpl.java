...
public class UserServiceImpl implements UserService {
    ...
    public User get(Long id) {
        return userRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Пользователь с идентификатором=" + id + " не найдено"));
    }
    ...
    public void delete(Long id) {
        try {
            ...
            throw new NotFoundException("Пользователь с идентификатором=" + id + " не найдено");
        }
    }
}
